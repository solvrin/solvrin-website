...
export function Services() {
  ...
  return (
    <section id="services" ref={containerRef} className="pt-32 pb-10 bg-[#050505] relative overflow-hidden">
      ...
      {/* Scroll-driven parallax background logo */}
      <motion.div 
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {servicesData.map((service, idx) => {
            const Icon = (IconMap as any)[service.icon];
            return (
               <motion.div
                key={service.id}
              ...
              >
                {/* Embedded Logo Mark for subtle branding animation on hover */}
                ...
                <div className="space-y-12">
                  {selectedService.processSteps.map((step, idx) => (
                    <motion.div 
                      ...
                      transition={{ duration: 0.8, delay: 0.2 + (idx * 0.1), ease: smoothEase }}
