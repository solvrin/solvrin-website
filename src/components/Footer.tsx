      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500 font-mono">
          ...
          <div className="flex gap-6 items-center">
            <a href="https://www.linkedin.com/company/solvrin-group/?lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_companies%3BEVdhadr6TtGL%2BpN88Eq7mQ%3D%3D" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              <Linkedin className="w-4 h-4" />
            </a>
            <a href="https://x.com/SolvrinGroup" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
