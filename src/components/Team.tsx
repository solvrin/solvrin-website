...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    imageUrl: '/joel.jfif',
    linkedIn: 'https://www.linkedin.com/in/joelyeo-/'
  },
  {
    id: 'hamza',
    name: 'Hamza Oksuz',
    ...
    imageUrl: '/hamza.jfif',
    linkedIn: 'https://www.linkedin.com/in/hamza-oksuz/'
  }
];
          ...
          {teamMembers.map((member, idx) => (
            ...
            >
              <a
                ...
                className="cursor-pointer aspect-4/5 bg-[#111] mb-8 overflow-hidden relative rounded-sm block"
              >
                <img
                  src={member.imageUrl}
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <Linkedin
                    size={16}
                    className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-gray-400 shrink-0"
                  />
                </div>
